...
SECRET_KEY = 'django-insecure-23*vv-ar$7q118!th=q$vi83@*bxq^fd&9valg6o0ltwl9w2_i'
...
STATIC_URL = 'calendar_app/calendar_note/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'calendar_notes', 'static')]
# Для продакшена:
